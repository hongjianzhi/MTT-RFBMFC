...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--video_h', type=int, default=768, help='')
    self.parser.add_argument('--video_w', type=int, default=768, help='')
    ...
    self.parser.add_argument('--out_thresh', type=float, default=0.1,
                             help='')
    ...
    self.parser.add_argument('--pre_thresh', type=float, default=0.3)
...
#       opt.new_thresh = max(opt.track_thresh, opt.new_thresh)
  ...
  def update_dataset_info_and_set_heads(self, opt, dataset):
    ...
    if opt.trades:
        ...
        opt.weights['bg_cost_volume'] = 1.0
    if opt.seg:
